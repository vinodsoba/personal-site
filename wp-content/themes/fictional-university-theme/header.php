      ...
      <div class="container">
        ...
        <div class="site-header__menu group">
         ...
         <ul>
              ...
              <li <?php if (get_post_type() == 'event' OR is_page('past-events')) echo 'class="current-menu-item"' ?>><a href="<?php get_post_type_archive_link( 'events' )?>">Events</a></li>
              <li><a href="#">Campuses</a></li>
              <li <?php if (get_post_type() == 'post') echo 'class="current-menu-item"'?>><a href="/blog">Blog</a></li>
          </ul>
